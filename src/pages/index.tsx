        ...
        <section className="w-full h-full inline-block p-32 pt-0 z-0">
          <div className="flex items-center justify-between w-full">
            ...
            <div className="w-1/2 flex flex-col gap-4 font-poppins overflow-hidden">
              <m.h1 
                className="font-nobel text-7xl home__heading text-zinc-950 dark:text-white"
              ...
              <m.h2 
                className="text-2xl text-zinc-600 dark:text-zinc-400 relative pl-24 home__subtitle font-montserrat"
                initial={{ x: -100 }}
                animate={{ x: 1 }}
                transition={{ duration: 1.4 }}
                >{'<Full-Stack Developer />'}</m.h2>
              
              <p className="text-l text-zinc-600 dark:text-zinc-200">Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum libero inventore quia illo! Voluptatem, qui.</p>
